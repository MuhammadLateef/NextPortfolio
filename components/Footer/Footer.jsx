...
const Footer = () => {
    return (
        <div className='bg-[#030611]' id='contact'>
            <div className="max-w-[1500px] mx-auto">
                <div className="md:w-[50%] w-[90%] mx-auto flex items-center flex-col">
                    <h1 className="mt-12 text-contentc text-[14px] font-medium rounded-full py-[4px] px-[20px] bg-[#374151] text-center lg:w-[20%] md:w-[40%] w-[60%] mx-auto">Contact Us</h1>
