                ...
                <nav className="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
                    ...
                    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                        <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
                            <Link href="#aboutus" smooth={true} duration={3000} className="text-[16px] font-medium text-white sm:py-6" aria-current="page">About</Link>
                            <Link href="#work" smooth={true} duration={500} className="text-[16px] font-medium text-white/[.8] hover:text-white sm:py-6">Work</Link>
                            <Link href="#skills" smooth={true} duration={500} className="text-[16px] font-medium text-white/[.8] hover:text-white sm:py-6">Skills</Link>
                            <Link href="#testimunials" smooth={true} duration={500} className="text-[16px] font-medium text-white/[.8] hover:text-white sm:py-6">Testimonials</Link>
                            <Link className="text-[16px] font-medium text-white/[.8] hover:text-white sm:py-6" href="#contact" smooth={true} duration={500}>Contact</Link>
                            <a className="text-[16px] font-medium text-white/[.8] hover:text-white sm:py-6" href="#"><Image src={logo} alt='dark'/></a>
                            <a href="/Assets/cv/resume.pdf" download className='py-[6px] px-[16px] bg-white rounded-xl text-[#030712] text-[16px] border hover:bg-[#D9411F] hover:text-white transition duration-300 font-medium'>Download CV</a>
