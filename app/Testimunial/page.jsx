...
const cardsData = [
    {
        ...
        title: "Mr Rupani ",
        message: "Founder - Ibn Sena Foundation"
    },
    {
        avator: logoavator,
    ...
    },
    {
        ...
        title: "Mr Jobe",
        message: "Founder - Seyna Yurt"
    },
]
const page = () => {
    return (
        <div className='bg-[#111827] py-8' id='testimunials'>
            <div className="max-w-[1500px] mx-auto">
                <h1 className="mt-12 text-contentc text-[14px] font-medium rounded-full py-[4px] px-[20px] bg-[#374151] text-center lg:w-[8%] md:w-[20%] w-[40%] mx-auto">Testimonials</h1>
                <p className='text-contentc text-[20px] text-center px-[20px] my-6'>Nice things people have said about me:</p>
                <div className="flex lg:flex-row flex-col w-[90%] mx-auto gap-[30px]">
                    {
                        cardsData.map((title, id) => (
                            <div key={id} className=" bg-[#1E2836] flex flex-col items-center justify-between transition duration-delay-200 hover:scale-105 hover:bg-[#0A0D12] lg:w-[30%] md:p-[48px] p-[25px] rounded-[12px]">
