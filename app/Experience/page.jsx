        ...
        <div>
            <div className='bg-dark'>
                <div className="max-w-[85rem] mx-auto">
                    <h1 className="mt-4 mb-4 text-contentc text-[14px] font-medium rounded-full py-[4px] px-[20px] bg-[#374151] text-center lg:w-[8%] md:md:w-[20%] w-[40%] mx-auto">Skills</h1>
                    <div className="w-[90%] mx-auto text-center">
                        <p className=' my-4 text-contentc text-[20px]'>Here is a quick summary of my most recent experiences:</p>
                    </div>
                    <div className="">
                        <div className="w-[70%] my-[50px] mx-auto bg-[#1F2937] p-[32px] rounded-[12px] flex md:flex-row flex-col justify-between items-start" style={{ boxShadow: '0px 25px 25px 0px rgba(0, 0, 0, 0.15)', }}>
